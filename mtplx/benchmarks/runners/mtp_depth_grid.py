        ...
        for min_depth in min_depth_values:
            ...
            for index, (case, ids) in enumerate(encoded):
                ...
                row: dict[str, Any] = {
                    ...
                    "verify_logits_eval_time_s": out.stats.verify_logits_eval_time_s,
                    ...
                    "verify_eval_unattributed_time_s": out.stats.verify_eval_unattributed_time_s,
                    ...
                    "first_round": out.stats.first_round,
            ...
            results.append(
                {
                    ...
                    "summary": {
                        ...
                        "verify_logits_eval_time_s": sum(row["verify_logits_eval_time_s"] for row in rows),
                        ...
                        "verify_target_distribution_time_s": sum(row["verify_target_distribution_time_s"] for row in rows),
                        "verify_eval_unattributed_time_s": sum(row["verify_eval_unattributed_time_s"] for row in rows),
                        "draft_time_s": sum(row["draft_time_s"] for row in rows),
                        "target_forward_time_s": sum(row["target_forward_time_s"] for row in rows),
                        "prompt_eval_time_s": sum(row["prompt_eval_time_s"] for row in rows),
